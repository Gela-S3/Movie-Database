...
const Single = () => {
  ...
  const getSingleData = async () =>{
    const data  = await axios.get(`http://www.omdbapi.com/?apikey=e9b7fc46&i=${id}`);
      ...
      <div className="row px-4 my-4">
        ...
        <div className="col-8">
          ...
          <div className="mt-2">
            ...
            <p className="m-0  card-bg py-1 px-2 text-yellow rounded d-inline-block"><span><i className="fa-solid fa-star font-size-12"></i></span>{singleMovie?.imdbRating}</p>
          </div>
          <div className="mt-2">
            <p className="m-0 fs-5 text-grey">Country</p>
            <p className="m-0 text-light font-size-14">
              {singleMovie?.Country}</p>
          </div>
          <div className="mt-2">
            <p className="m-0 fs-5 text-grey">Language</p>
            <p className="m-0 text-light font-size-14">
              {singleMovie?.Language}</p>
          </div>
          <div className="mt-2">
            <p className="m-0 fs-5 text-grey">Duration</p>
            <p className="m-0 text-light font-size-14">
              {singleMovie?.Runtime}</p>
          </div>
          <div className="mt-2">
